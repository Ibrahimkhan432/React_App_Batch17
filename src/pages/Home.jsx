        ...
        <div class="grid max-w-7xl px-4 py-8 lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 justify-center  mx-auto">
          <div class="mr-auto flex flex-col items-center place-self-center lg:col-span-7  text-center sm:text-left ">
            ...
            <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
              ...
              adipisicing elit. Similique ducimus repellat tempora voluptates
              voluptatum iure illo a recusandae, ex veritatis!
            </p>
          ...
          <div class="lg:mt-0 lg:col-span-5 lg:flex w-90 mt-10 sm:mt-0">
            <img
              className="w-full rounded-full"
              src="https://media.licdn.com/dms/image/v2/D4E03AQG6zk-914vnlA/profile-displayphoto-scale_200_200/B4EZo0x8bZKMAY-/0/1761822102703?e=2147483647&v=beta&t=5_fXygb9EuCTNaqsMJaCLCuHAaXRZ-4ejG304qyqaA8"
              alt="mockup"
            />
          </div>
        </div>
